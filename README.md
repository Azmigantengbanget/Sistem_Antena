...
<body>
  ...
  { "en": "Apa nama PDU (Protocol Data Unit) di Network Layer?", "id": "Packet." },
  ...
  { "en": "Apa fungsi dari ARP (Address Resolution Protocol)?", "id": "Memetakan Alamat IP ke Alamat MAC." },
  ...
  { "en": "Apa itu 'XML (Extensible Markup Language)'?", "id": "Bahasa markup untuk mendeskripsikan data." },
  ...
  { "en": "Apa fungsi sublapisan MAC (Media Access Control)?", "id": "Mengontrol akses ke media fisik." },
  ...
  { "en": "Mengapa keamanan jaringan SCADA (Supervisory Control and Data Acquisition) penting?", "id": "Karena mengontrol infrastruktur kritis." },
  ...
  { "en": "Apa itu 'OSI model (Open Systems Interconnection model)'?", "id": "Model Interkoneksi Sistem Terbuka." },
  { "en": "Apa itu 'TCP/IP model (Transmission Control Protocol/Internet Protocol model)'?", "id": "Model yang menjadi dasar internet." },
  ...
  { "en": "Apa itu 'IEEE (Institute of Electrical and Electronics Engineers)'?", "id": "Institut Insinyur Listrik dan Elektronika." },
  { "en": "Apa itu 'IETF (Internet Engineering Task Force)'?", "id": "Gugus Tugas Rekayasa Internet." },
  { "en": "Apa itu 'W3C (World Wide Web Consortium)'?", "id": "Konsorsium World Wide Web." },
  { "en": "Apa itu 'ISO (International Organization for Standardization)'?", "id": "Organisasi Internasional untuk Standardisasi." },
  { "en": "Apa itu 'ANSI (American National Standards Institute)'?", "id": "Institut Standar Nasional Amerika." },
  ...
  { "en": "Apa itu 'TFTP (Trivial File Transfer Protocol)'?", "id": "Protokol Transfer File Sepele." },
  { "en": "Kapan TFTP (Trivial File Transfer Protocol) digunakan?", "id": "Untuk transfer konfigurasi dan OS perangkat jaringan." },
  ...
  { "en": "Apa itu 'DNSSEC (Domain Name System Security Extensions)'?", "id": "Ekstensi Keamanan Sistem Penamaan Domain." },
  { "en": "Fungsi DNSSEC (Domain Name System Security Extensions)?", "id": "Memastikan respons DNS otentik dan tidak diubah." },
  { "en": "Apa itu 'DANE (DNS-based Authentication of Named Entities)'?", "id": "Otentikasi Entitas Bernama Berbasis DNS." },
  ...
  { "en": "Apa itu 'DMARC (Domain-based Message Authentication, Reporting and Conformance)'?", "id": "Membangun di atas SPF dan DKIM." },
  ...
  { "en": "Apa itu 'content delivery network' (CDN)?", "id": "Jaringan pengiriman konten." },
  { "en": "Bagaimana cara kerja CDN (Content Delivery Network)?", "id": "Menyimpan salinan (cache) konten di banyak lokasi." },
  { "en": "Apa itu 'anycast'?", "id": "Menggunakan satu IP untuk banyak server." },
  { "en": "Bagaimana anycast memilih server?", "id": "Routing memilih server terdekat secara geografis." },
  { "en": "Apa itu 'geolocation'?", "id": "Menentukan lokasi geografis dari alamat IP." },
  { "en": "Apa itu 'RFC (Request for Comments)'?", "id": "Dokumen yang mendefinisikan standar internet." },
  { "en": "Siapa yang menerbitkan RFC (Request for Comments)?", "id": "Internet Engineering Task Force (IETF)." },
  { "en": "Apa itu 'IANA (Internet Assigned Numbers Authority)'?", "id": "Otoritas Nomor yang Ditugaskan Internet." },
  { "en": "Apa tugas IANA (Internet Assigned Numbers Authority)?", "id": "Mengelola alokasi alamat IP global." },
  { "en": "Apa itu 'RIR (Regional Internet Registry)'?", "id": "Registri Internet Regional." },
  { "en": "Apa RIR (Regional Internet Registry) untuk wilayah Asia Pasifik?", "id": "APNIC (Asia-Pacific Network Information Centre)." },
  { "en": "Apa itu 'WHOIS'?", "id": "Protokol untuk mencari info pendaftaran domain/IP." },
  ...
  { "en": "Apa itu 'unified communications' (UC)?", "id": "Integrasi berbagai alat komunikasi." },
  { "en": "Apa itu 'IP telephony'?", "id": "Teknologi untuk layanan telepon melalui IP." },
  { "en": "Apa itu 'SIP (Session Initiation Protocol)'?", "id": "Protokol inisiasi sesi." },
  { "en": "Apa itu 'codec'?", "id": "Coder-Decoder, untuk kompresi data." },
  { "en": "Contoh codec audio?", "id": "MP3, AAC, G.711." },
  { "en": "Contoh codec video?", "id": "H.264, H.265 (HEVC), VP9." },
  { "en": "Apa itu 'mean opinion score' (MOS)?", "id": "Ukuran kualitas subjektif dari suara/video." },
  ...
  { "en": "Apa itu 'network baseline'?", "id": "Ukuran performa normal dari sebuah jaringan." },
  { "en": "Apa itu 'root bridge' dalam STP (Spanning Tree Protocol)?", "id": "Switch referensi utama dalam topologi STP." },
  ...
  { "en": "Apa itu 'UDLD (UniDirectional Link Detection)'?", "id": "Deteksi Link Searah." },
  ...
  { "en": "Apa itu 'VTP (VLAN Trunking Protocol)'?", "id": "Protokol Trunking VLAN (Cisco)." },
  { "en": "Apa itu 'VTP pruning'?", "id": "Mencegah lalu lintas VLAN yang tidak perlu." },
  { "en": "Apa itu 'DTP (Dynamic Trunking Protocol)'?", "id": "Protokol Trunking Dinamis (Cisco)." },
  { "en": "Apa itu 'CDP (Cisco Discovery Protocol)'?", "id": "Protokol Penemuan Cisco." },
  { "en": "Apa itu 'LLDP (Link Layer Discovery Protocol)'?", "id": "Protokol Penemuan Lapisan Link (standar)." },
  { "en": "Apa itu 'PoE (Power over Ethernet)'?", "id": "Daya melalui Ethernet." },
  ...
  { "en": "Apa itu 'PAgP (Port Aggregation Protocol)'?", "id": "Protokol Agregasi Port (Cisco)." },
  { "en": "Apa itu 'SD-WAN (Software-Defined Wide Area Network)'?", "id": "WAN Terdefinisi Perangkat Lunak." },
  { "en": "Keuntungan SD-WAN (Software-Defined Wide Area Network)?", "id": "Manajemen WAN yang terpusat dan fleksibel." },
  ...
  { "en": "Apa itu 'VXLAN (Virtual Extensible LAN)'?", "id": "LAN Virtual yang Dapat Diperluas." },
  { "en": "Fungsi VXLAN (Virtual Extensible LAN)?", "id": "Membuat jaringan Lapisan 2 di atas Lapisan 3." },
  ...
  { "en": "Apa itu 'intent-based networking' (IBN)?", "id": "Jaringan berbasis tujuan." },
  ...
  { "en": "Apa itu 'IP SLA (Service-Level Agreement)'?", "id": "Fitur Cisco untuk mengukur performa jaringan." },
  ...
  { "en": "Apa itu 'MPLS (Multi-protocol Label Switching)'?", "id": "Switching Label Multi-protokol." },
  { "en": "Apa itu 'label' dalam MPLS (Multi-protocol Label Switching)?", "id": "Header kecil yang disisipkan antar lapisan 2 dan 3." },
  ...
  { "en": "Apa itu 'DMVPN (Dynamic Multipoint VPN)'?", "id": "VPN Multipoint Dinamis." },
  { "en": "Apa itu 'IPsec (Internet Protocol Security)'?", "id": "Keamanan Protokol Internet." },
  { "en": "Fungsi utama IPsec (Internet Protocol Security)?", "id": "Menyediakan enkripsi dan otentikasi di lapisan IP." },
  ...
  { "en": "Apa itu 'GETVPN (Group Encrypted Transport VPN)'?", "id": "VPN Transport Terenkripsi Grup." },
  { "en": "Apa itu 'wireless LAN controller' (WLC)?", "id": "Kontroler LAN Nirkabel." },
  { "en": "Apa itu 'lightweight access point' (LWAP)?", "id": "Access point ringan." },
  { "en": "Apa itu 'CAPWAP (Control and Provisioning of Wireless Access Points)'?", "id": "Protokol untuk manajemen AP." },
  { "en": "Apa itu 'rogue access point'?", "id": "AP tidak sah yang terhubung ke jaringan." },
  { "en": "Apa itu 'wireless intrusion prevention system' (WIPS)?", "id": "Sistem pencegahan intrusi nirkabel." },
  ...
  { "en": "Apa itu 'OFDMA (Orthogonal Frequency-Division Multiple Access)'?", "id": "Akses Ganda Pembagian Frekuensi Ortogonal." },
  ...
  { "en": "Apa itu 'APIPA (Automatic Private IP Addressing)'?", "id": "Pengalamatan IP Privat Otomatis." },
  { "en": "Rentang alamat APIPA (Automatic Private IP Addressing)?", "id": "169.254.0.0/16." },
  ...
  { "en": "Apa itu 'GPON (Gigabit-capable Passive Optical Network)'?", "id": "Jaringan Optik Pasif Berkemampuan Gigabit." },
  { "en": "Apa itu 'OLT (Optical Line Terminal)'?", "id": "Terminal Jalur Optik." },
  { "en": "Apa itu 'ONT (Optical Network Terminal)'?", "id": "Terminal Jaringan Optik." },
  ...
  { "en": "Apa itu 'non-stop forwarding' (NSF)?", "id": "Terus meneruskan paket saat control plane restart." },
  { "en": "Apa itu 'route dampening'?", "id": "Mengurangi dampak rute yang tidak stabil." },
  { "en": "Apa itu 'route reflector' di BGP (Border Gateway Protocol)?", "id": "Menyederhanakan konfigurasi iBGP." },
  { "en": "Apa itu 'BGP confederation'?", "id": "Membagi satu AS besar menjadi sub-AS." },
  { "en": "Apa itu 'equal-cost multi-path' (ECMP)?", "id": "Load balancing melalui beberapa rute dengan metrik sama." },
  { "en": "Apa itu 'policy-based routing' (PBR)?", "id": "Routing berdasarkan kebijakan selain alamat tujuan." },
  { "en": "Apa itu 'IP SLA (Service-Level Agreement)'?", "id": "Fitur Cisco untuk mengukur performa jaringan." },
  ...
  { "en": "Apa itu 'QUIC (Quick UDP Internet Connections)'?", "id": "Protokol transport baru di atas UDP." },
  { "en": "Apa keuntungan QUIC (Quick UDP Internet Connections) dibanding TCP?", "id": "Koneksi lebih cepat, mengatasi head-of-line blocking." },
  ...
  { "en": "Apa beda SSE (Server-Sent Events) dan WebSocket?", "id": "SSE hanya satu arah (server ke klien)." },
  ...
  { "en": "Apa itu 'gRPC (Google RPC)'?", "id": "Framework RPC modern yang dikembangkan Google." },
  ...
  { "en": "Apa itu 'DKIM (DomainKeys Identified Mail)'?", "id": "Menambahkan tanda tangan digital ke email." },
  { "en": "Apa itu 'DMARC (Domain-based Message Authentication, Reporting and Conformance)'?", "id": "Membangun di atas SPF dan DKIM." },
  { "en": "Apa itu 'XMPP (Extensible Messaging and Presence Protocol)'?", "id": "Protokol untuk pesan instan." },
  { "en": "Di mana XMPP (Extensible Messaging and Presence Protocol) sering digunakan?", "id": "Untuk aplikasi instant messaging (chat)." },
  { "en": "Apa itu 'MQTT (Message Queuing Telemetry Transport)'?", "id": "Protokol antrean pesan telemetri." },
  { "en": "Kapan MQTT (Message Queuing Telemetry Transport) ideal digunakan?", "id": "Untuk komunikasi perangkat IoT." },
  { "en": "Model komunikasi MQTT (Message Queuing Telemetry Transport)?", "id": "Publish-subscribe (pub/sub)." },
  ...
  { "en": "Apa itu 'CoAP (Constrained Application Protocol)'?", "id": "Protokol aplikasi untuk perangkat terbatas." },
  { "en": "Di mana CoAP (Constrained Application Protocol) digunakan?", "id": "Untuk perangkat IoT dengan sumber daya terbatas." },
  ...
  { "en": "Apa itu 'stratum' dalam NTP (Network Time Protocol)?", "id": "Tingkat hierarki dari sebuah server waktu." },
  ...
  { "en": "Apa itu 'RMON (Remote Monitoring)'?", "id": "Pemantauan Jarak Jauh." },
  ...
  { "en": "Apa itu 'RADIUS (Remote Authentication Dial-In User Service)'?", "id": "Layanan Otentikasi Pengguna Dial-In Jarak Jauh." },
  ...
  { "en": "Apa itu 'NTP (Network Time Protocol)'?", "id": "Protokol Waktu Jaringan." },
  { "en": "Apa itu 'stratum' di NTP (Network Time Protocol)?", "id": "Tingkat hierarki dari sebuah server waktu." },
  { "en": "Stratum 0 adalah apa?", "id": "Jam referensi presisi tinggi (misal, atom)." },
  { "en": "Apa itu 'SNMP (Simple Network Management Protocol)'?", "id": "Protokol Manajemen Jaringan Sederhana." },
  { "en": "Apa itu 'NMS (Network Management Station)'?", "id": "Stasiun Manajemen Jaringan." },
  { "en": "Apa itu 'SNMP agent'?", "id": "Perangkat lunak di perangkat yang dimonitor." },
  { "en": "Apa itu 'MIB (Management Information Base)'?", "id": "Basis Informasi Manajemen." },
  { "en": "Apa itu 'OID (Object Identifier)'?", "id": "Pengidentifikasi Objek." },
  ...
  { "en": "Apa itu 'IPFIX (IP Flow Information Export)'?", "id": "Versi standar terbuka dari NetFlow." },
  ...
  { "en": "Apa itu 'MTU (Maximum Transmission Unit)'?", "id": "Unit Transmisi Maksimum." },
  { "en": "Apa itu 'MSS (Maximum Segment Size)'?", "id": "Ukuran Segmen Maksimum." },
  ...
  { "en": "Apa itu 'BPDU (Bridge Protocol Data Unit)'?", "id": "Unit Data Protokol Bridge (paket STP)." },
  ...
  { "en": "Apa itu 'CSMA/CA (Carrier Sense Multiple Access/Collision Avoidance)'?", "id": "Metode akses media untuk Wi-Fi." },
  ...
  { "en": "Apa itu 'RTS/CTS (Request to Send/Clear to Send)'?", "id": "Mekanisme untuk menghindari tabrakan." },
  { "en": "Fungsi RTS/CTS (Request to Send/Clear to Send)?", "id": "Mengatasi masalah 'hidden node'." },
  ...
  { "en": "Apa itu 'RAID (Redundant Array of Independent Disks)'?", "id": "Susunan Redundan Disk Independen." },
  ...
  { "en": "Apa itu 'FDDI (Fiber Distributed Data Interface)'?", "id": "Antarmuka Data Terdistribusi Fiber." },
  { "en": "Apa itu 'ATM (Asynchronous Transfer Mode)'?", "id": "Mode Transfer Asinkron." },
  { "en": "Berapa ukuran sel ATM (Asynchronous Transfer Mode)?", "id": "53 byte." },
  { "en": "Apa itu 'Frame Relay'?", "id": "Teknologi WAN packet-switched." },
  { "en": "Apa itu 'X.25'?", "id": "Standar jaringan WAN packet-switched awal." },
  { "en": "Apa itu 'ISDN (Integrated Services Digital Network)'?", "id": "Jaringan Digital Layanan Terpadu." },
  ...
  { "en": "Apa itu 'SCSI (Small Computer System Interface)'?", "id": "Antarmuka Sistem Komputer Kecil." },
